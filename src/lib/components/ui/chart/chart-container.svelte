...
<div
  ...
  class={cn(
    ...
    // Filled marks like bars and pie slices should not get the default outline stroke.
    '[&_.lc-bar]:stroke-transparent [&_.lc-rect]:stroke-transparent [&_.lc-pie-arc]:stroke-transparent [&_.lc-arc-line]:stroke-transparent',
